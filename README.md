...
| `aiops project dashboard` | 프로젝트 진행률, readiness, warning, Agent/Role, 활성 일감 요약과 Mermaid work map 표시 |
...
`tests/visual_dashboard.sh`와 CI의 `dashboard browser visual` job은 locale별 HTML, Mermaid, 반응형 layout과 주요 상호작용을 실제 Chrome에서 검증한다.
