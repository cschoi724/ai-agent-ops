...
1. 현재 템플릿 버전은 `.ai/VERSION`
2. 버전별 변경 이력은 `.ai/CHANGELOG.md`
3. 처음 적용하거나 흐름을 익히는 중이면 `.ai/tutorial.md`
4. `.ai/workflow.md`
5. `.ai/document_governance.md`
6. `.ai/project_workspace.md`
7. `.ai/agent_registry.md`
8. `.ai/capabilities.md`
9. `.ai/commit_policy.md`
10. `.ai/task_queue.md`
11. 자기 역할에 맞는 `.ai/agents/*.md`
12. 작업 유형에 맞는 `.ai/workflows/*.md`
13. 프로젝트가 초기화되어 있으면 `.ai_project/current_context.md`와 `.ai_project/tasks/` 문서
